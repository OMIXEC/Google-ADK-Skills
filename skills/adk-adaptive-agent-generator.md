---
name: adk-adaptive-agent-generator
description: Build custom Google ADK agents from natural language descriptions. Auto-detects capabilities (voice/vision/RAG/tools), maps to ADK patterns, designs architecture, generates complete project with agent.py/tools/config/deployment. Supports multi-agent, MCP tools, RAG integration. Maximum 2 questions before generating. Shows approval workflow with architecture preview.
version: 1.0.0
---
