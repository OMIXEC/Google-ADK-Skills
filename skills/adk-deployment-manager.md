---
name: adk-deployment-manager
description: Deploy ADK agents to production on Cloud Run (serverless), Vertex AI Agent Engine (managed), or GKE (Kubernetes). Generates Dockerfiles, deployment configs (YAML/cloudbuild), CI/CD pipelines. Configure memory/CPU limits, autoscaling (min/max instances), region, secrets. Supports generate_only mode for config preview without deployment.
version: 1.0.0
---
